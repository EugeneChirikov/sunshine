package com.mates120dev.sunshine.service;
...
public class SunshineService extends IntentService {
    static private final String LOG_TAG = IntentService.class.getSimpleName();
    static public final String LOCATION_QUERY_EXTRA = "location_query_extra";
