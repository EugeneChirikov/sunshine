package com.mates120dev.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    private static final int LOCATION_ID = 104;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        {
            case WEATHER: {
                long _id = mOpenHelper.getWritableDatabase().insert(WeatherContract.WeatherEntry.TABLE_NAME,
                        null,
                        values);
                if (_id > 0)
            ...
            case LOCATION: {
                long _id = mOpenHelper.getWritableDatabase().insert(WeatherContract.LocationEntry.TABLE_NAME,
                        null,
                        values);
                if (_id > 0)
